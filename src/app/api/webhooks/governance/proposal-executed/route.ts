...
const ProposalExecutedPayloadSchema = z.object({
  eventId: z.string(),
  eventType: z.literal('proposal-executed'),
...
async function handleProposalExecuted(data: z.infer<typeof ProposalExecutedPayloadSchema>['data']) {
  // Log the proposal executed event
  console.log('[Webhook] Proposal executed:', {
  ...
  // TODO: Process execution plan actions
  // TODO: Notify governance participants

  return { processed: true }
}

// POST /api/webhooks/governance/executed
export async function POST(request: NextRequest) {
  try {
    ...
    const parseResult = parseWebhookEvent('proposal-executed', payload)
    ...
    const validationResult = ProposalExecutedPayloadSchema.safeParse(payload)
    ...
    // Process event (async)
    handleProposalExecuted(validationResult.data.data).catch(console.error)
